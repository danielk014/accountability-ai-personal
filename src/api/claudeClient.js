...
disease_risks: Array of disease risk objects for this specific food. Each object: {"disease":"disease name","risk":"high/moderate/low","reason":"why this food contributes"}. Include risks like: colorectal cancer (processed meat, WHO Group 1/2A), cardiovascular disease (trans fats, excess saturated fat, high sodium), type 2 diabetes (high sugar, ultra-processed), liver disease (alcohol, high fructose), obesity, hypertension, etc. Only include diseases with genuine scientific evidence linking this food. Empty array [] for clean whole foods with no known disease links.
...
ch_trigger_reason: if trigger is true, brief explanation why. Empty string if not a trigger.`;
  ...
  return {
    ...
    diseaseRisks:  Array.isArray(p.disease_risks) ? p.disease_risks : [],
